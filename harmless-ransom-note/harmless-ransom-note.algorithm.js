...
console.log(harmlessRansomNote('this is a secret note for you from a secret admirer',
	...
	'places as they are far from populated areas but it is worth the effort a tip i have ' +
	'for you is to go early in the morning when it is not so hot out also note that you must ' +
	'wear hiking boots this is one of the best places i have ever visited'));

// Algorithm time complexity = O(n + m) => linear time complexity